...
number_plates = {{ number_plates }} #Must be 3 or less!
...
plate_dilution_list = gen_vol_list(plate_dilution_vol)
first_aliquot_vol = 20
first_analytical_dilution_vol = 200
first_analytical_dilution_list = gen_vol_list(first_analytical_dilution_vol)
second_aliquot_vol = 20
second_analytical_dilution_vol = 200
second_analytical_dilution_list = gen_vol_list(second_analytical_dilution_vol)
third_aliquot_vol = 20
third_analytical_dilution_vol = 200
